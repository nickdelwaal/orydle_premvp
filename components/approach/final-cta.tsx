...
export function ApproachFinalCta() {
    ...
    // Total time for graph to assemble before CTA appears
    const nodesDone = 0.6; // nodes finish appearing
    const edgesDone = nodesDone + 0.9; // edges finish drawing
    const ctaDelay = edgesDone + 0.3; // CTA fades in after
